      ...
      <?php while ( have_posts() ) : the_post(); ?>
						...
						<div class="blog__row">
							...
							<div class="blog__cnt animation fadeInRgt">
								<h1 class="blog_tit"><?php the_title(); ?></h1>
	<div class="wp-detail"><?php the_content(); ?>
				  </div>
							</div>
						</div>
...
<div class="ichiran"><a href="<?php echo home_url('/'); ?>">一覧へ戻る</a></div>
<div class="prenex"> <?php previous_post_link('%link', '&lt; 前へ'); ?>
